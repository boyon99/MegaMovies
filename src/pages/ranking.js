...
import { videoMap as trailerList } from "../movieInfoList/trailerList";
import { posterMap as posterList } from "../movieInfoList/posterList";
    ...
    .map((item, index) => {
      ...
      return /* html */ `
        <li class="videos-item">
          ...
          <video src=${trailerList.get(item.title)} poster=${posterList.get(
        item.title
      )} controls></video>
        </li>
        `;
